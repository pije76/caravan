    ...
    try:
        ...
        for iccid in iccid_list:
            ...
            for month in range(1, 13):
                ...
                tf_data = list(TblTrafficData.objects.filter(iccid=iccid, date__gte=start_date, date__lte=end_date))
            ...
            for day in range(1, monthrange(today.year, today.month)[1] + 1):
                ...
                tf_data = list(TblTrafficData.objects.filter(iccid=iccid, date=start_date))
                if len(tf_data) == 0:
